  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 h-full flex items-center px-4 md:px-8 lg:px-16 py-24">
        ...
        >
          ...
          >
            <motion.p
              variants={textVariants}
              className="text-lg md:text-xl font-light leading-relaxed drop-shadow-[0_1px_4px_rgba(0,0,0,0.8)]"
            >
            ...
            <motion.p
              variants={textVariants}
              className="text-base md:text-lg font-light leading-relaxed drop-shadow-[0_1px_4px_rgba(0,0,0,0.8)]"
            >
      ...
      <motion.div
        ...
        animate={
          isInView ? { opacity: 0.12, scale: 1 } : { opacity: 0, scale: 0.8 }
        }
